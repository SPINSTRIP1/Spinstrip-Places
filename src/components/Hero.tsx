...
export default function Hero({ query, onQuery }: HeroProps) {
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 pt-28 sm:px-6 sm:pt-36">
      <div
        className="rise-in mx-auto max-w-5xl text-center"
      ...
      >
        <span>
          <strong className="font-display text-[#0F0F0F]">140+</strong> places
          listed
        </span>
        <span className="h-1 w-1 rounded-full bg-primary-light" />
        <span>
          <strong className="font-display text-[#0F0F0F]">60+</strong> events
          created
        </span>
        <span className="h-1 w-1 rounded-full bg-primary-light" />
        <span>
          <strong className="font-display text-[#0F0F0F]">2k+</strong> dishes on
          menus
        </span>
      </div>
    </section>
