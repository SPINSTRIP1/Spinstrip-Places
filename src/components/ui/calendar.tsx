    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-[var(--cell-size)] text-primary-text aria-disabled:opacity-50 p-0 select-none",
